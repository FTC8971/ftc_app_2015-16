 ...
 * @version 2016-06-17-15-47
 */
public class DiamondTeleOp_IRI extends DiamondBotHardware_IRI
    ...
    @Override public void loop ()
    {
        ...
        if (gamepad2.dpad_up) //if the up pad is pressed
        {
            ...
            try
            {
                ...
                m_back_bumper_position(.1); //raise the bumpers
            }
            catch (Exception p_exception)
            {
